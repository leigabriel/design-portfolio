...
function HeroSection() {
  ...
  return (
    <section className={'relative h-screen overflow-visible ' + (isDarkMode ? 'bg-[#212631]' : 'bg-[#f2f2f2]')}>
      ...
      <header ref={headerRef} className="absolute top-0 left-0 right-0 flex justify-between items-start z-50" style={{ padding: '2rem 5rem' }}>
      ...
      <footer ref={footerRef} className="absolute bottom-0 left-0 right-0 flex justify-between items-end z-50" style={{ padding: '2rem 5rem' }}>
        <span className={'header-text opacity-0 ' + textColor}>Portfolio 2026</span>
        <span className={'header-text opacity-0 ' + textColor}>Graphic Designer / Web Developer</span>
      </footer>
