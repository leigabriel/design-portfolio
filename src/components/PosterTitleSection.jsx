...
function PosterTitleSection() {
    ...
    return (
        <section id="poster-title" className="folder-section relative min-h-[150px] md:min-h-[200px] overflow-hidden bg-[#ffffff]">
            <div className="section-padding flex flex-col justify-between h-full">
                <div className="flex-1 flex flex-col justify-center">
                    <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 sm:gap-0">
                        <div ref={numberRef} className="flex items-center gap-2 md:gap-4 shrink-0">
                            ...
                            <span className="text-5xl md:text-6xl lg:text-8xl font-bold tracking-tight text-black">01.</span>
                        </div>
                        <h2 ref={titleRef} className="font-[Timetwist] text-5xl md:text-6xl lg:text-8xl font-bold tracking-tight uppercase text-black">POSTERS</h2>
                    </div>
                </div>
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-end gap-2 sm:gap-0 mt-6 md:mt-8" ref={footerRef}>
                    <span className="section-footer-text text-black/60">Posters Design</span>
                    <span className="section-footer-text text-black/60">Click to View Full Photo</span>
                </div>
            </div>
        </section>
    )
