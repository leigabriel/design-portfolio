                ...
                <div className="flex-1 flex flex-col justify-center">
                    <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 sm:gap-0">
                        <div ref={numberRef} className="flex items-center gap-2 md:gap-4 shrink-0">
                            ...
                            <span className={'text-5xl md:text-6xl lg:text-8xl font-bold tracking-tight ' + textColor}>02.</span>
                        </div>
                        <h2 ref={titleRef} className={'font-[Timetwist] text-5xl md:text-6xl lg:text-8xl font-bold tracking-tight uppercase ' + textColor}>Web</h2>
                    </div>
                </div>
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-end gap-2 sm:gap-0 mt-6 md:mt-8">
                    <span className={'section-footer-text ' + textMuted}>Web Projects</span>
                    <span className={'section-footer-text ' + textMuted}>Click to View Full Details</span>
                </div>
            </div>
        </section>
    )
